                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">55% complete</p>
                                            ...
                                            <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item mr-2"><a href="account_holder.php" class="boder-under">Account Holder</a></li>
                                                    ...
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-blue">
                                                                <label for="">ACCOUNT HOLDER</label><br/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="account_info.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-1 button_font_small">Account Information</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="account_holder.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="button_font_small">Fatca Requirement <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
