                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            <li class="breadcrumb-item mr-2 pb-4"><a href="c-general-part.php" class="boder-under"> General Partnership Information</a></li>
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="c-corporations.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-1 button_font_small">C-Corporations</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="c-corporation-income.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-1 button_font_small">C-Corp. Income <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
