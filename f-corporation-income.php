                                    ...
                                    <div class="row">
                                             ...
                                             <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">88% complete</p>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item mr-2"><a href="f-corporation-income.php" class="boder-under">Income and Expenses</a></li>
                                                            <li class="breadcrumb-item mr-2"><a href="f-corporation-goods.php">Cost of Goods Sold</a></li>
                                                    ...
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <label for="">Which currency are income and expenses recorded on this form:</label><br/>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <label for="">Gross Receipts/Income:</label><br/>
                                                                <input type="text" class="form-control col-md-2" id="exampleFormControlInput1">
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-md-3 margin-top-inverse ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <label for=""></label><br/>
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="f-general-part.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-1 button_font_small">General Partnership</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="f-corporation-goods.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-1 button_font_small">F-Corp. Goods <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
