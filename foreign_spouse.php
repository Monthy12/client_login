                                    ...
                                    <div class="row">
                                             <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">27% complete</p>
                                            
                                                    <div class="progress mb-5">
                                                        <div class="progress-bar" role="progressbar" style="width: 27%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-11 ml-5">
                                                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                            <ol class="breadcrumb">
                                                                ...
                                                                <li class="breadcrumb-item mr-2"><a href="foreign_spouse.php" class="boder-under">Spouse</a></li>
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="foreign_taxpayer.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-1 button_font_small">Taxpayer Income</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="foreign_house.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-3 button_font_small">Housing Exclusion <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
