                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">94% complete</p>
                                                ...
                                                <div class="col-md-11 ml-5">
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item mr-2"><a href="partnership-income.php">Income and Expenses</a></li>
                                                            <li class="breadcrumb-item mr-2"><a href="partnership-goods.php" class="boder-under">Cost of Goods Sold</a></li>
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="partnership-income.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-0 button_font_small">Partnership. Income</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="not-profits.php" class="btn btn-outline-warning  color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-1 button_font_small">Not for Profits <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
