                                    ...
                                    <div class="row">
                                             ...
                                             <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">90% complete</p>
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item mr-2"><a href="partnership-income.php">Cost of Goods Sold</a></li>
                                                    ...
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <label for="">Is this your first time filing a 1065 partnership return with us?</label><br/>
                                                ...
                                                <div id="foreign_id">
                                                    ...
                                                    <div class="row mt-3" id="no_amended_returns">
                                                        <div class="col-md-12 ml-5">
                                                            <div class="form-group">
                                                                <div class="form-group light-grey">
                                                                    <label for="">Provide a copy of the last filed Form 1065 of the partnership if any</label> <span class="pl-3">
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="mr-5">
                                                                    <a href="p-general-part.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
