                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">50% complete</p>
                                            ...
                                            <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item mr-2"><a href="property_tax_exclusion.php" class="boder-under">Tax Exclusions</a></li>
                                                    ...
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <p>In addition, you may qualify for a $250,000 exclusion of gain from the sale of your <br>property, $500,000 if married filing jointly, if you meet certain requirements. </p>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <label for="">I meet the following requirements and can take the exclusion *</label><br/>
                                                            ...
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="property_sales.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-1 button_font_small">Property Sales</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="account_info.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-0 button_font_small">Account Info. <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
