                                    ...
                                    <div class="row">
                                             ...
                                             <div class="col-md-3 d-none d-md-block sidebar-background">
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p class="margin-left-large light-grey">81% complete</p>
                                            
                                                    <div class="progress mb-5">
                                                        <div class="progress-bar" role="progressbar" style="width: 81%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            <li class="breadcrumb-item mr-2 pb-4"><a href="s-general-part.php">General Partnership Information</a></li>
                                                            <li class="breadcrumb-item mr-2"><a href="s-corporation-income.php">Income and Expenses</a></li>
                                                            <li class="breadcrumb-item mr-2"><a href="s-corporation-income.php">Cost of Goods Sold</a></li>
                                                    ...
                                                    <div class="col-md-12 ml-5">
                                                        <div class="form-group">
                                                            <div class="form-group light-grey">
                                                                <label for="">Is this your first time filing an 1120s  corporate return with us?</label><br/>
                                                ...
                                                <div id="foreign_id">
                                                    ...
                                                    <div class="row mt-3" id="no_amended_returns">
                                                        <div class="col-md-12 ml-5">
                                                            <div class="form-group">
                                                                <div class="form-group light-grey">
                                                                    <label for="">Provide a copy of the last filed Form 1120s of the corporation if any</label> <span class="pl-3">
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="">
                                                                    <a href="c-corporation-income.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                        <span class="pl-1 button_font_small">C-Corp. Income</span>
                                                                    </a>
                                                                </div>

                                                                <div class="mr-5">
                                                                    <a href="s-general-part.php" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-1 button_font_small">S-Corp. Partnership <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
